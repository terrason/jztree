 ...
 *
 * <p>Some methods in this class were copied from the Spring Framework so we
 * didn't have to re-invent the wheel, and in these cases, we have retained all
...
public class StringUtils {
     ...
     *
     * <p>Copied from the Spring Framework while retaining all license,
     ...
     * @return
     * <code>true</code> starts with the specified prefix (ignoring case),
     ...
     *
     * <ol> <li>If the specified
     * <code>String</code> is
     * <code>null</code>, return
     * <code>null</code></li> <li>If not
     * <code>null</code>, {@link String#trim() trim()} it.</li> <li>If the
     * trimmed string is equal to the empty String (i.e. &quot;&quot;), return
     * <code>null</code></li> <li>If the trimmed string is not the empty string,
     * return the trimmed version</li>. </ol>
     *
     ...
     * @return a populated-but-trimmed String or
     ...
     * the specified
     * {@code delimiter} argument. Useful for {@code toString()} implementations
     * and log messages.
     *
     * @param array the array whose contents will be converted to a string
     ...
     *
     * <p>This method's implementation is very loosely based (with significant
     * modifications) on <a href="http://blogs.bytecode.com.au/glen">Glen
     * Smith</a>'s open-source <a
     ...
     * file.
     *
     * <p>That file is Apache 2.0 licensed as well, making Glen's code a great
    ...
    public static String lowFirstChar(String s) {
        ...
        String prefix = firstChar.toLowerCase();
